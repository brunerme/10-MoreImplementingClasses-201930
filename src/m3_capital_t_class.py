    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        *** See   dimensions.pdf   to understand the following! ***
        ...
        # ---------------------------------------------------------------------
        h_rect_point_1 = rg.Point(intersection_center.x - 0.5*width, intersection_center.y - 0.5*letter_thickness)
        h_rect_point_2 = rg.Point(intersection_center.x + 0.5*width, intersection_center.y + 0.5*letter_thickness)
        self.h_rect = rg.Rectangle(h_rect_point_1, h_rect_point_2)

        v_rect_point_1 = rg.Point(intersection_center.x + 0.5*letter_thickness, intersection_center.y + height - 0.5*letter_thickness)
        v_rect_point_2 = rg.Point(intersection_center.x - 0.5*letter_thickness, intersection_center.y - 0.5*letter_thickness)
        self.v_rect = rg.Rectangle(v_rect_point_1, v_rect_point_2)
    ...
    def clone(self):
        ...
        #######################################################################
        height = self.v_rect.corner_1.y - self.h_rect.corner_1.y
        intersection_center = rg.Point(0.5*(self.h_rect.corner_1.x+self.h_rect.corner_2.x), 0.5*(self.h_rect.corner_1.y + self.h_rect.corner_2.y))
